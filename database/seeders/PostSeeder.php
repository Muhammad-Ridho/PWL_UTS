...
class PostSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $barang = array(
            array('BR001', 'Piring', 'peralatan rumah', 3000, 100),
            ...
            array('BR014', 'meja', 'peralatan rumah', 3000, 100),
            array('BR015', 'kursi', 'peralatan rumah', 3000, 100),
            array('BR016', 'kopi lanang', 'minuman', 3000, 100),
            array('BR017', 'minyak goreng', 'kebutuhan', 3000, 100),
            array('BR018', 'sapu', 'peralatan rumah', 3000, 100),
